...
var renderCitacita = fs.readFileSync("./pages/cita_cita.html");
var renderRiwayathidup = fs.readFileSync("./pages/riwayat_hidup.html");
...
var server = http.createServer(function(request,response){
    ...
    if (q.pathname == "/" && request.method == "GET"){
        ...
        if (keyword){
            ...
            response.write("<h3 style='text-align: center;'><b></b>EITT ! Maaf Website Tidak bisa Diakses</b></h3>");
    ...
    else if (request.url == '/cita_cita'){
        response.writeHead(200, { "Content-Type": "text/html" });
        response.write(renderCitacita);
        response.end();
    }
    else if (request.url == '/riwayat_hidup'){
        response.writeHead(200, { "Content-Type": "text/html" });
        response.write(renderRiwayathidup);
        response.end();
    }
